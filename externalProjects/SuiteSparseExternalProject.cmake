...
if(ROBOT_FARM_SKIP_SuiteSparseExternalProject)
  ...
  string(REPLACE ";" "${ROBOT_FARM_LIST_SEPARATOR}"
    SUITESPARSE_CUDA_ARCHITECTURES_ESCAPED "${CMAKE_CUDA_ARCHITECTURES}")
  ...
  externalproject_add(SuiteSparseExternalProject
    ...
    -DSUITESPARSE_CUDA_ARCHITECTURES:STRING=${SUITESPARSE_CUDA_ARCHITECTURES_ESCAPED}
