...
(
  ...
  (
    ...
    apt-get install -y --no-install-recommends $(sh "${SOURCE_TREE}/tools/extractDependencies.sh" Basics "${SOURCE_TREE}/systemDependencies.json") && \
    ...
    apt-get install -y --no-install-recommends $(sh "${SOURCE_TREE}/tools/extractDependencies.sh" Compilers "${SOURCE_TREE}/systemDependencies.json")
